...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (10U * 1024U)        /*Size memory used by mem_alloc (in bytes)*/
...
#define LV_VDB_SIZE         10 * 1024  /*Size of VDB in pixel count*/
...
#define USE_LV_FONT_DEJAVU_20_SUP          1
#define USE_LV_FONT_DEJAVU_20_LATIN_EXT_A  0
#define USE_LV_FONT_DEJAVU_20_LATIN_EXT_B  0
#define USE_LV_FONT_DEJAVU_20_CYRILLIC     0
#define USE_LV_FONT_SYMBOL_20_BASIC        1
#define USE_LV_FONT_SYMBOL_20_FILE         1
#define USE_LV_FONT_SYMBOL_20_FEEDBACK     1
